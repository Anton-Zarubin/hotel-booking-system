...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, NotificationKafkaDto> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(
                consumerConfigs(),
                new StringDeserializer(),
                new JsonDeserializer<>(NotificationKafkaDto.class, false)
        );
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, NotificationKafkaDto> kafkaListenerContainerFactory() {
    ...
    public Map<String, Object> producerConfigs() {
        ...
        props.put(ProducerConfig.CLIENT_ID_CONFIG, "notification-service");
        return props;
    }
