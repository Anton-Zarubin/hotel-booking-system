...
public class KafkaConfig {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "hotel-service-group");
        return props;
    }
    ...
    @Bean
    public ConsumerFactory<String, HotelKafkaDto> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(
                consumerConfigs(),
                new StringDeserializer(),
                new JsonDeserializer<>(HotelKafkaDto.class, false)
        );
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, HotelKafkaDto> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, HotelKafkaDto> factory
    ...
    public Map<String, Object> producerConfigs() {
        ...
        props.put(ProducerConfig.CLIENT_ID_CONFIG, "hotel-service");
        return props;
    }
