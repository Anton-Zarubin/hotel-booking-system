...
public class KafkaConfig {
    ...
    public Map<String, Object> producerConfigs() {
        ...
        props.put(ProducerConfig.CLIENT_ID_CONFIG, "booking-service");
        return props;
    }

    @Bean
    public ProducerFactory<String, HotelKafkaDto> producerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfigs());
    }

    @Bean
    public KafkaTemplate<String, HotelKafkaDto> kafkaTemplate() {
        KafkaTemplate<String, HotelKafkaDto> template = new KafkaTemplate<>(producerFactory());
    ...
    @Bean
    public ConsumerFactory<String, BookingKafkaDto> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, BookingKafkaDto> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, BookingKafkaDto> factory
